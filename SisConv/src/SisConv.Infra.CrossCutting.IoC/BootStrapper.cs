...
namespace SisConv.Infra.CrossCutting.IoC
{
	public class BootStrapper
	{
		public static void RegisterServices(Container container)
		{
			...
			container.Register<IDocumentoCandidatoAppService, DocumentoCandidatoAppService>(Lifestyle.Scoped);
			container.Register<ITipoDocumentoAppService, TipoDocumentoAppService>(Lifestyle.Scoped);
			...
			container.Register<IDocumentoCandidatoService, DocumentoCandidatoService>(Lifestyle.Scoped);
			container.Register<ITipoDocumentoService, TipoDocumentoService>(Lifestyle.Scoped);
			...
			container.Register<IDocumentoCandidatoRepository, DocumentoCandidatoRepository>(Lifestyle.Scoped);
